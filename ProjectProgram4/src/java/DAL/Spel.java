...
public class Spel  implements java.io.Serializable {
    ...
    public Spel(Category category, String titel, String omschrijvingSpel, String benodigdheden, int counter, int aantalPersonenVanaf, int aantalPersonenTot, Set comments) {
       this.category = category;
       this.titel = titel;
       this.omschrijvingSpel = omschrijvingSpel;
       this.benodigdheden = benodigdheden;
