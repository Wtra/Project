...
public class CommentToevoegenController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("edit") != null) {
            ...
            comment.setSpel(SpelServices.getSpel(Integer.parseInt(request.getParameter("id")),false));
            comment.setComment(request.getParameter("comment"));
            comment.setDatum(new Date());
            comment.setUsername(request.getParameter("username"));
            comment.setReactieVerwijderen(0);
            ...
            Spel spel = SpelServices.getSpel(Integer.parseInt(request.getParameter("id")),false);
